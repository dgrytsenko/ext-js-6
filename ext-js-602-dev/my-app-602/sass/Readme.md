...
folder are mapped to the application's root namespace, 'MyApp602'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MyApp602' in the same way
as `"MyApp602/sass/src"`.
